 ...
 * @author facac
 */
public class FrameNivelCisterna extends javax.swing.JFrame {
     ...
     */
    public FrameNivelCisterna() {
        initComponents();
        super.setTitle("Tela de valores Históricos do Nível da Cisterna");
        super.setBounds(100, 100, 900, 800);
        JLabel titulo = new javax.swing.JLabel();
        titulo.setBounds(300, 10 , 400, 30);
        titulo.setText("Histórico Nível Cisterna ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameNivelCisterna.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameNivelCisterna().setVisible(true);
           }
        });
    }
